...
Serie::Serie(std::string name, std::string genre, int launch_year, int duration, int num_episodios, int num_temporadas):Video("Serie", name, genre, launch_year, duration){
